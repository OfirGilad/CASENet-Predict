...
class ResNet(nn.Module):
    ...
    def forward(self, x, for_vis=False):
        ...
        cropped_score_feats5 = self.crop_layer(upsampled_score_feats5,
                                               offset=4)  # BS X 20 X 352 X 352. The output of it will be used to get a loss for this branch.
        ...
        fused_feats = self.ce_fusion(
            concat_feats)  # BS X 20 X 352 X 352. The output of this will gen loss for this branch. So, totaly 2 loss. (same loss type)
